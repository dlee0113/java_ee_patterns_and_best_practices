...
*/
package com.abien.presentation.hello;

import com.abien.business.hello.HelloWorld;
...
public class HelloController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        String msg = request.getParameter("hello");
        try {
            out.println("<html>");
            out.println("<head>");
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet HelloController at " + helloWorld.hello(msg) + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally { 
            out.close();
