...
*/
package com.abien.patterns.presentation.singleton;

import com.abien.patterns.business.singleton.MasterDataCache;
...
public class SingletonTester extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SingletonTester</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SingletonTester at " + masterDataCache.get("startup") + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally { 
            out.close();
